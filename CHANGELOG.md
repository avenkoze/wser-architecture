...
- Closed the reproduced audio calibration, scoped cookie-partition and shared
  process-sampling implementation findings. Focused builds, adversarial/native
  checks and extension validation passed; 0.8.0 remains an unsigned test candidate
  with separate release dependencies (ADR 0025).
