...
Temporary scan reports also use ordered per-tab storage operations. Delayed writes cannot recreate a report after its queued navigation/tab-close clear; completed queues release their tab keys. Fault injection and isolated browser lifecycle checks passed.
